...
@Repository
public class CommonApplicationDAOImpl extends HibernateDaoSupport implements CommonApplicationDAO{
	...
	public List<UnitMeasure> getUnitsMeasure() {
		Object objectUnitsMeasure = getHibernateTemplate().find("FROM UnitMeasure");
		List<UnitMeasure> unitsMeasure = new ArrayList<UnitMeasure>();

		if (!objectUnitsMeasure.equals(null) && objectUnitsMeasure instanceof List) {
