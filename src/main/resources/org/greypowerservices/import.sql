...
insert into chemical_products (id, unit_of_measure, price, image_path) values (1,'unit', '11.11', '/root/images1');
insert into products (id, name, description) values (100,'P100', 'P100 Description');
insert into chemical_products (id, unit_of_measure, price, image_path) values (100,'unit', '100.100', '/root/images100');
